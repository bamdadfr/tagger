...
from tagger.constants import MAX_CALLS_PER_MINUTE


# see: https://github.com/enricobacis/limit/blob/master/limit/limit.py
def limit(limit: int = MAX_CALLS_PER_MINUTE, every: int = 60):
